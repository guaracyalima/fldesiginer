    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                <img src="{{ asset('img/logo/min.jpeg') }}" alt="" id="logo-branco">
...
<header id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            ...
            <div class="fill img-topo" style="background-image:url({{ asset('img/bg/1.jpg') }});"></div>
        </div>

        <div class="item">

            <div class="fill img-topo"  style="background-image:url({{ asset('img/bg/2.jpg') }});"></div>
        </div>

        <div class="item">

            <div class="fill img-topo"  style="background-image:url({{ asset('img/bg/3.jpg') }});"></div>
        </div>

        <div class="item">

            <div class="fill img-topo"  style="background-image:url({{ asset('img/bg/4.jpg') }});"></div>
        </div>
    </div>
...
<div class="topo-textos" >
    ...
    <div class="container">
        <div class="row">
            ...
            <h3 id="title-head">FL Design</h3>
            <div class="">
                <p id="text-head">
                  A sua festa começa aqui
                </p>
                </div>
            ...
            <aside class="image-bg-fixed-height">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-6">
                        <img src="{{ asset('img/profile/trafica.jpg') }}" alt="" class="img-responsive" id="fachada-img">
                    </div>
    ...
    <div class="slogan">
        <div class="container-fluid">
            <div class="col-sm-12 col-lg-12">
                <img src="{{ asset('img/logo/max.jpeg') }}" alt="" class
                <br>
                <br>
                <br>
                <br>
                <p id="toyopecas-slogan">Tudo para a sua festa</p>
            </div>
        </div>
    </div>
    ...
    <div class="products" id="produtos">
        ...
        <div class="col-sm-12 col-lg-12">
            <p id="produtos-title-section">Portifiolio</p>
        </div>
        ...
        <div class="col-sm-6 col-lg-6 col-md-offset-3">
            ...
            <div class="col-sm-6 col-lg-6 col-md-offset-3">
                ...
                <button class="rectangle filter-button" data-filter="parafuso">
                  Camisetas
                </button>
                <button class="rectangle filter-button" data-filter="roela">
                  Ensaios
                </button>
                <button class="rectangle filter-button" data-filter="freio">
                  Casamentos
                </button>
            </div>
            ...
            <div class="container grid-products">
                <div class="row ">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop filter parafuso">
                        <img src="{{ asset('img/products/p1.jpeg') }}" alt="" class=" products-img">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop filter roela">
                        <img src="{{ asset('img/products/p2.jpeg') }}" alt="" class=" products-img">
                        <p>Titulo do produto</p>
                        <button class="btn btn-default">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            Adicionar
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop filter parafuso">
                        <img src="{{ asset('img/products/p3.jpeg') }}" alt="" class=" products-img">
                        <p>Titulo do produto</p>
                        <button class="btn btn-default">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            Adicionar
                ...
                <div class="row products-shop">
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop filter roela">
                        <img src="{{ asset('img/products/p4.jpeg') }}" alt="" class=" products-img">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop">
                        <img src="{{ asset('img/products/p5.jpeg') }}" alt="" class=" products-img">
                        <p class="products-name">Titulo do produto</p>
                        <button class="btn btn-default products-cart-btn">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            Adicionar
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 products-shop filter parafuso">
                        <img src="{{ asset('img/products/p6.jpeg') }}" alt="" class=" products-img">
                        <p class="products-name">Titulo do produto</p>
                        <button class="btn btn-default products-cart-btn">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                            Adicionar
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 col-lg-10 col-md-offset-1">
                        <p class="testmonials-content">
                            O cabra é bom no que faz.</p>

                            <p id="testmonials-author">guabirabaDev - develoepr</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="fooder">
            ...
            <p class="footer-content">
                Copyright @ 2017 FL Design - developed by <a href="https://www.linkedin.com/in/guaracyalima/" target="_blank">guabirabaDev</a>
            </p>
        </div>
